          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFadeText
                ...
                text="Backend-Leaning Full Stack Developer | TypeScript, Node.js, PostgreSQL | Production-Focused End-to-End"
              />
        ...
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <details className="group rounded-lg border border-border bg-muted/30 p-4">
              ...
              <div className="mt-3">
                <Markdown className="prose max-w-full text-pretty font-sans text-sm text-muted-foreground dark:prose-invert">
                  {`Today I completed a full backend deployment pipeline from scratch:

- Express + TypeScript + Prisma + PostgreSQL (Neon)
- Dev & Production environment separation
- EC2 provisioning (Ubuntu 24.04)
- PM2 process management
- Nginx reverse proxy
- Custom domain mapping (dev.onewish.fun)
- SSL via Let's Encrypt (auto-renew enabled)
- HTTPS secured API
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of backend and full-stack
                  projects, from real-time systems to production deployments.
